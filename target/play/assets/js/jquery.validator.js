...
;(function(factory) {
    ...
    new Rules({
         ...
         * @example
            The simplest:       remote(path/to/bizTest);
            With parameters:    remote(path/to/bizTest, name1, name2, ...);
            By GET:             remote(get:path/to/bizTest, name1, name2, ...);
            Name proxy:         remote(path/to/bizTest, name1, proxyname2:name2, proxyname3:#id3, ...)
            Query String        remote(path/to/bizTest, foo=1&bar=2, name1, name2, ...)
         */
